...
"""
Contains functions that test  the routes in app.py
"""
...
def profile_unlogged() -> None:
    """
     A func that Attempt to access the profile page without being logged in.
    """
...
def profile_logged(session_id: str) -> None:
    """
    A func that Access the profile page using the provided session ID.
    """
    response = rq.get(
...
def log_out(session_id: str) -> None:
    """
    A func that Log out using the provided session ID.
    """
    response = rq.delete(
...
def reset_password_token(email: str) -> str:
    """
    A func that Request a reset token for the provided email.
    """
...
def update_password(email: str, reset_token: str, new_password: str) -> None:
    """
    Update the password associated with the provided .
    """
    response = rq.put(
